    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          'ol',
          null,
          this.props.options.map(function (option, keyNum) {
            return React.createElement(Option, { key: keyNum, optionText: option });
          })
...
var AddOption = function (_React$Component6) {
  ...
  _createClass(AddOption, [{
    ...
    value: function handleAddOption(event) {
      ...
      var option = event.target.elements.newOption.value.trim();
